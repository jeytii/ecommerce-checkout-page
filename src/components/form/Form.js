	...
	<section className='form color--white'>
		...
		<form className='form__form' action=''>
			...
			<FormItem title='Name On Card' className='form__item'>
				<input className='form__input transparent color--white' type='text' />
			</FormItem>
			...
			<div className='form__item flex--center'>
				<FormItem title='Expiration Date' className='flex--1'>
					<div className='form__select-container flex--center'>
						<select className='form__select transparent color--white' name='month'>
							<option value="">MM</option>
						</select>
						<select className='form__select transparent color--white' name='year'>
				...
				<FormItem title='CVV' className='form__cvv'>
					<input className='form__input transparent color--white' type='text' placeholder='XXX' />
				</FormItem>
			</div>

			<div className='form__item'>
				<input className='form__submit transparent color--white bold' type='submit' value='Check Out.' />
			</div>
